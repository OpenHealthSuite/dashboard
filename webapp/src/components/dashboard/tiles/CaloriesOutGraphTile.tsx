...
export function CaloriesOutGraphTile({
  ...
  const caloriesString = `Total: ${caloriesOutTotal.toLocaleString()} Calories | Avg: ${Math.floor(caloriesOutTotal / caloriesArray.length).toLocaleString()} Calories`;
  return (
    <FnDashboardTile
      headerText="Last Week Calories Burned"
